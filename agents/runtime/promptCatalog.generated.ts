...
export const AGENT_PROMPT_CATALOG: AgentPromptCatalogEntry[] = [
  ...
  },
  {
    ...
    "sourcePath": "agents/tools/foundationTools.ts",
    "sourceLine": 49,
    "content": "Foundation axis for block operations: time or space.",
    "kind": "tool-schema",
    "chars": 52
  },
  {
  ...
  },
  {
    ...
    "sourcePath": "agents/tools/foundationTools.ts",
    "sourceLine": 522,
    "content": "Operate the two-axis Foundation container: create/delete time or space blocks, update block documents, and assign compatible Flow nodes to one block folder. Character and scene libraries belong to Lookbook. Project root and project index are read-only.",
    "kind": "tool-schema",
    "chars": 252
  },
  {
